...
# Azure Deployment Script for AutoGen Blueprint
# Requires: Azure CLI (az)

set -e

RESOURCE_GROUP="rg-openai-agents-blueprint"
LOCATION="eastus"

echo "🚀 Starting Azure Deployment (OpenAI Agents)..."
...
IMAGE_URI="$ACR_NAME.azurecr.io/app-openai-agents-api:latest"
